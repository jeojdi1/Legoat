import { ChevronLeft, ChevronRight, MoreHorizontal, SlidersHorizontal, Home, Lightbulb, Music } from "lucide-react";
...
const MusicStreamingHome = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link to="/music-recommendation" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Music
            </Link>
            <Link to="/mental-state" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Mental State
            </Link>
      ...
      {/* Main Content */}
      <div className="px-4 sm:px-6 py-6 sm:py-8 space-y-8 sm:space-y-10 bg-music-bg-primary text-music-text-primary">

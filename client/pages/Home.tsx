  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <Navbar>
        {/* Desktop Navigation */}
        <NavBody>
          <div className="relative z-20 mr-4 flex items-center space-x-2">
          ...
          <div className="relative z-20 flex items-center gap-4">
            <Link to="/login" className="px-4 py-2 rounded-md bg-transparent text-black text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center dark:text-white">
              Log in
            </Link>
            <Link to="/login" className="px-4 py-2 rounded-md bg-green-600 text-white text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
              Sign up
            </Link>
          </div>
        </NavBody>
          ...
          >
            ...
            <div className="flex w-full flex-col gap-4">
              <Link
                to="/login"
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full px-4 py-2 rounded-md bg-transparent text-black text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center dark:text-white"
              >
                Log in
              </Link>
              <Link
                to="/login"
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full px-4 py-2 rounded-md bg-green-600 text-white text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
              >
                Sign up
              </Link>
            </div>
        ...
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          <div className="mb-4 w-full flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-spotify-green/40 to-spotify-green/60 rounded-full blur-xl opacity-20"></div>
              <div className="relative bg-gradient-to-r from-spotify-green to-spotify-green/80 p-4 rounded-full">
                <Music className="h-8 w-8 text-white" />
              </div>
            </div>
          </div>
          <h1 className="text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:text-6xl lg:leading-[1.1]">
            Connect Your Mind to <span className="text-spotify-green">Music</span>
          </h1>
          ...
          <div className="flex w-full max-w-sm items-center space-x-2">
            <Input 
              ...
              className="border-spotify-green/20 focus:border-spotify-green focus:ring-spotify-green"
            />
      ...
      <section className="container py-12 md:py-24 lg:py-32 bg-muted/50">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-4">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-spotify-green text-white shadow-lg">
              1
            </div>
      ...
      <section className="container py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <Button size="lg" asChild className="bg-spotify-green hover:bg-spotify-green/90">
